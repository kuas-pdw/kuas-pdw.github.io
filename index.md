...
PhD students and early-career researchers in management (generally within 5 years of completing a doctoral degree). Master's students planning to pursue a PhD are also eligible to apply.
...
#### Day 1: August 25 — All Participants

| Time | Session |
|------|---------|
| 13:30–14:30 | Session 1: Opening, introductions, and networking |
| 14:30–15:30 | Session 2: Panel discussion |
...
- Panelists (tentative): Prof. Katsuki Aoki (Meiji University - online), Prof. Hirokazu Kano (Kyushu University - online), Prof. Toru Yoshikawa (Waseda University - on-site)
...
Acceptance decisions and mentor matching results will be communicated approximately one week after the submission deadline.
...
経営学研究を行う博士課程の学生および若手研究者（博士課程修了後5年以内を目安）。博士課程進学を予定している修士課程の学生も応募可能です。
...
| 時間 | 内容 |
|------|------|
| 13:30〜14:30 | セッション1：開会・自己紹介と交流 |
| 14:30〜15:30 | セッション2：パネルディスカッション |
| 18:00〜20:00 | 懇親会ディナー（オンサイト参加者のみ） |

**セッション2：パネルディスカッション「日本で国際的に活躍する研究者からの学び」**
- 登壇候補：青木 克生 先生（明治大学 - オンライン）、加納 拡和 先生（九州大学 - オンライン）、好川 透 先生（早稲田大学 - オンサイト）
- モデレーター：稲田 昂弘 先生
...
| 時間 | 内容 |
|------|------|
| 9:00〜10:00 | セッション1：個別フィードバック（採択者のみ） |
| 10:10〜11:10 | セッション2：パネルディスカッション（全参加者対象） |
| 11:30〜13:00 | ネットワーキングランチ（オンサイト参加者のみ） |

**セッション1：個別フィードバック**  
採択者は、メンター1名につき1〜3名のグループに振り分けられ、自身の研究に対する個別フィードバックを受けます（事前に論文またはアブストラクトを提出・採択された方が対象）。※一部のメンターが当日参加できない場合は、個別にスケジュールを調整いただきます。
